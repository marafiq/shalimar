...
public class ShalimarGenerator : IIncrementalGenerator
{
        ...
        List<ComponentInfo> components)
    {
        ...
        foreach (var c in v2)
        {
            ...
            tsSb.AppendLine("import { setV2Props, useV2Props } from '@generated/store'");
            ...
            tsSb.AppendLine($"        setV2Props('{typeName}', props)");
        ...
        List<ComponentInfo> components)
    {
        ...
        tsSb.AppendLine("}");
        tsSb.AppendLine();
        tsSb.AppendLine("export type V2ComponentKey = keyof V2PropsByComponent");
        tsSb.AppendLine();
        ...
        List<ComponentInfo> components)
    {
        ...
        tsSb.AppendLine("import { useV2Props, getV2Props } from './shalimar-v2-store.g'");
        tsSb.AppendLine();
